<?php
/**
 * EstoquemovConsumoForm Master/Detail
 * @author  Fred Azv.
 */
class EstoquemovConsumoForm extends TPage
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Inventário de Consumo (Lançamentos de movimentação em estoque Consumo)');
        ...
        $this->form->addAction('Voltar', new TAction(['EstoquemovConsumoList','onReload']), 'fa:arrow-circle-left red');
        ...
        //     let tipo;
        //     tipo = form_EstoquemovConsumo.controla_lote.value;
        //         if(tipo == "S"){
        //             form_EstoquemovConsumo.quantidade.readOnly = true;
        //         }else{
        //             form_EstoquemovConsumo.quantidade.readOnly = false;
        //         }
        //     };
        ...
        //         let quantidadeLote = form_EstoquemovConsumo.detail_quantidade.value;
        //         let quantidadeTotal = form_EstoquemovConsumo.quantidade.value;

        //         totalSoma = parseInt(quantidadeLote) + parseInt(quantidadeTotal);

        //         form_EstoquemovConsumo.quantidade.value = totalSoma;
        //         form_EstoquemovConsumo.quantidade.readOnly = true;
        //     };
        // ');
    }
    ...
    //     TForm::sendData( 'form_EstoquemovConsumo', $data );
    ...
    public function onEdit($param)
    {
        try
        {
            ...
            if (isset($param['key']))
            {
                ...
                $object = new EstoquemovConsumo($key);
            ...
            if($data->tipo == 'E')
            {
                ...
                if($comp)
                {
                    ...
                    {   
                        ...
                        {
                            $composicao = new EstoquemovConsumo;
