<?php
/**
 * ProdutoSubgrupoFormList Form List
 * @author  <your name here>
 */
class ProdutoSubgrupoFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_ProdutoSubgrupo');
        $this->form->setFormTitle('Sub-Grupo de Produtos');
        ...
        $this->form->addFields( [ new TLabel('Grupo de Produto') ], [ $produto_grupo_id ] );
        ...
        $column_produto_grupo_id = new TDataGridColumn('produto_grupo->nome', 'Grupo de Produto', 'left');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for ProdutoSubgrupo
            $repository = new TRepository('ProdutoSubgrupo');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new ProdutoSubgrupo($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new ProdutoSubgrupo;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('sample'); // open a transaction
                $object = new ProdutoSubgrupo($key); // instantiates the Active Record
