<?php
/**
 * EstoquemovImobilizadoForm Master/Detail
 * @author  Fred Azv.
 */
class EstoquemovImobilizadoForm extends TPage
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Inventário (Lançamentos de movimentação em estoque de Imobilizados)');
        ...
        $this->form->addAction('Voltar', new TAction(['EstoquemovImobilizadoList','onReload']), 'fa:arrow-circle-left red');
        ...
        //     let tipo;
        //     tipo = form_EstoquemovImobilizado.controla_lote.value;
        //         if(tipo == "S"){
        //             form_EstoquemovImobilizado.quantidade.readOnly = true;
        //         }else{
        //             form_EstoquemovImobilizado.quantidade.readOnly = false;
        //         }
        //     };
        ...
        //         let quantidadeLote = form_EstoquemovImobilizado.detail_quantidade.value;
        //         let quantidadeTotal = form_EstoquemovImobilizado.quantidade.value;

        //         totalSoma = parseInt(quantidadeLote) + parseInt(quantidadeTotal);

        //         form_EstoquemovImobilizado.quantidade.value = totalSoma;
        //         form_EstoquemovImobilizado.quantidade.readOnly = true;
        //     };
        // ');
    }
    ...
    public static function onSomarTotal() {
        ...
        TForm::sendData( 'form_EstoquemovImobilizado', $data );
    ...
    public function onSave()
    {
        try
        {
            ...
            $data = $this->form->getData();
            $master = new EstoquemovImobilizado;
            ...
            if($data->tipo == 'E')
            {
                ...
                if($comp)
                {
                    ...
                    {   
                        ...
                        {
                            $composicao = new EstoquemovImobilizado;
