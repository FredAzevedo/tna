...
class SystemUserForm extends TPage
{
    ...
    public function __construct()
    {
        ...
        $unit_id             = new TDBCombo('system_unit_id','permission','SystemUnit','id','unidade');
        ...
        $row = $this->form->addFields( [ new TLabel('Unidade Principal'), $unit_id ],
                                       [ new TLabel('Tela Inicial'), $frontpage_id ]);
        $row->layout = ['col-sm-6', 'col-sm-6' ];

        $row = $this->form->addFields( [ new TLabel('Login'), $login ],
                                       [ new TLabel('Senha'), $password ],
                                       [ new TLabel('Confirmar Senha'), $repassword ]
        );
        ...
        $this->unit_list = new TDBCheckList('unit_list', 'permission', 'SystemUnit', 'id', 'unidade');
