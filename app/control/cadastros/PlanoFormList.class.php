<?php
/**
 * PlanoFormList Form List
 * @author  <your name here>
 */
class PlanoFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $row = $this->form->addFields( [ new TLabel('Plano de Contas'), $pc_receita_id ],
                                       [ new TLabel('Descrição do Plano'), $pc_receita_nome ]);
        ...
        $column_unit_id = new TDataGridColumn('unit_id', 'Unidade', 'left');
