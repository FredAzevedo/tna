<?php
/**
 * TipoPgtoFormList Registration
 * @author  Fred Azv.
 */
class TipoPgtoFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('TipoPgto');   // defines the active record
        $this->setDefaultOrder('id', 'asc');         // defines the default order
        // $this->setCriteria($criteria) // define a standard filter
        
        // creates the form
        $this->form = new BootstrapFormBuilder('form_TipoPgto');
        $this->form->setFormTitle('Tipo de Pagamento');
