<?php
/**
 * CentroCustoFormList Form List
 * @author  Fred Azv.
 */
class CentroCustoFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle('Centro de Custo');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for CentroCusto
            $repository = new TRepository('CentroCusto');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new CentroCusto($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new CentroCusto;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('sample'); // open a transaction
                $object = new CentroCusto($key); // instantiates the Active Record
