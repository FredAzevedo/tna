<?php
class RelContaPagar extends TWindow
{
    public function __construct()
    {
        parent::__construct();
        parent::setTitle('Contas a pagar');
        parent::setSize(0.8,0.8);    
        $object = new TElement('object');
        $object->data  = "/tmp/contapagar.pdf";
        ...
        try
        {
            ...
            if ($units)
            {
                ...
                {  
                    ...
                    $pdf->Cell(275,5,"CONTAS A PAGAR",0,0,'C'); 
                }
            }  
            ...
            $pdf->SetXY(20, 60);
            $pdf->Cell(80,5,'Fornecedor',0,0,'C');
            ...
            try
            {
                ...
                if ($customers)
                {
                    ...
                    foreach ($customers as $customer)
                    {
                        ...
                        $fornecedor = explode(" ", $customer->fornecedor->nome_fantasia);
                        $pdf->SetX(20);
                        $pdf->Cell(80,5,$customer->fornecedor->nome_fantasia,1,0,'L');

                        $pdf->SetX(100);
                        $pdf->Cell(60,5,$customer->pc_despesa->nome,1,0,'L');

                        $pdf->SetX(160);
                        $pdf->Cell(55,5,$customer->descricao,1,0,'L');
