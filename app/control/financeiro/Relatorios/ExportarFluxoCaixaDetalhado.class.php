...
class ExportarFluxoCaixaDetalhado extends TWindow
{
    private $form; 
    private $total;
    private $data_inicio;
    ...
    function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_ExportarFluxoCaixaDetalhado_report');
    ...
    function onGenerate()
    {
        try
        {
            ...
            WHERE movimentacao_bancaria.conta_bancaria_id = :conta_bancaria_id and movimentacao_bancaria.data_baixa between :dataini and :datafim and movimentacao_bancaria.deleted_at is null
            ...
            if ($data)
            {
                ...
                if (!empty($table))
                {
                    ...
                    $saldoAnterReceita->execute(array($dataini,$conta_bancaria_id));
                    ...
                    $saldoAnterDespesa->execute(array($datafim,$conta_bancaria_id));
