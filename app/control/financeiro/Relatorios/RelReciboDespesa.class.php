<?php
class RelReciboDespesa extends TWindow
{
    public function __construct()
    {
        ...
        $object->data  = "tmp/RelReciboDespesa.pdf";
        ...
        try
        {
            ...
            if ($units)
            {
                ...
                {  
                    ...
                    $recibo = new Recibo($id);
                    $conteudos  = RelatorioCustomizado::where('pc_despesa_id','=',$recibo->pc_despesa_id)->load();
           ...
           $units2  = SystemUnit::where('id','=',TSession::getValue('userunitid'))->load();
            ...
            if ($units2)
            {
                ...
                {  
                    ...
                    $recibo2 = new Recibo($id);
                    $conteudos2  = RelatorioCustomizado::where('pc_despesa_id','=',$recibo2->pc_despesa_id)->load();
                    ...
                    if($conteudos2) 
                    {
                        ...
                        new TMessage('info', 'Atenção: Não existe relatório customizado com referência para o Plano de Contas desse Contas a Pagar');
                    }
                }
            }
            
            $arq = PATH."/tmp/RelReciboDespesa.pdf";  
            $pdf->Output( $arq, "F");
