<?php
/**
 * BoletoRegraFormList Form List
 * @author  <your name here>
 */
class BoletoRegraFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_BoletoRegra');
        $this->form->setFormTitle('Regras');
        ...
        $row = $this->form->addFields( [ new TLabel('ID'), $id ],
                                       [ new TLabel('Juros %'), $valor_juros ],
                                       [ new TLabel('Multa %'), $valor_multa ],
                                       [ new TLabel('Conta Bançaria'), $conta_bancaria_id ]
        );
        ...
        $column_valor_juros = new TDataGridColumn('valor_juros', 'Valor Juros', 'left');
        $column_valor_multa = new TDataGridColumn('valor_multa', 'Valor Multa', 'left');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for BoletoRegra
            $repository = new TRepository('BoletoRegra');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new BoletoRegra($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new BoletoRegra;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('sample'); // open a transaction
                $object = new BoletoRegra($key); // instantiates the Active Record
