...
class BancoFormList extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $id = new TEntry('id');
        $num_banco = new TEntry('num_banco');
        ...
        $row = $this->form->addFields( [ new TLabel('ID'), $id ],    
                                       ...
                                       [ new TLabel('Tipo'), $num_banco ],
                                       [ new TLabel('Nome do banco'), $nome_banco ]);
        ...
        $column_num_banco = new TDataGridColumn('num_banco', 'Nº Banco', 'left');
        $column_nome_banco = new TDataGridColumn('nome_banco', 'Nome do Banco', 'left');
        $column_unit_id = new TDataGridColumn('system_unit->unidade', 'Unidade', 'right');


        // add the columns to the DataGrid
        $this->datagrid->addColumn($column_id);
        $this->datagrid->addColumn($column_num_banco);
