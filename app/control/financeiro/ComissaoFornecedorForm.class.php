<?php
/**
 * ComissaoFornecedorForm Form
 * @author  <your name here>
 */
class ComissaoFornecedorForm extends TPage
{
    protected $form; 
    ...
    public function __construct( $param )
    {
        ...
        $row = $this->form->addFields( [ new TLabel('Tipo'), $tipo ],    
                                       [ new TLabel('Fornecedor comissionado'), $fornecedor_id ],
        ...
        $this->form->addAction('Voltar', new TAction(['ComissaoFornecedorList','onReload']), 'fa:arrow-circle-left red');
        
        // vertical box container
        $container = new TVBox;
        $container->style = 'width: 100%';
        ////$container->add(new TXMLBreadCrumb('menu.xml', 'ComissaoFornecedorList'));
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new ComissaoFornecedor;  // create an empty object
