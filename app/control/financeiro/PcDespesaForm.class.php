 ...
 */
class PcDespesaForm extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_PcDespesa');
        $this->form->setFormTitle('Plano de Contas Despesas');
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new PcDespesa;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                TTransaction::open('sample'); // open a transaction
                $object = new PcDespesa($key); // instantiates the Active Record
