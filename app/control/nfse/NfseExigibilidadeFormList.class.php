<?php
/**
 * NfseExigibilidadeFormList Registration
 * @author  <your name here>
 */
class NfseExigibilidadeFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('NfseExigibilidade');   // defines the active record
        $this->setDefaultOrder('id', 'asc');         // defines the default order
        // $this->setCriteria($criteria) // define a standard filter
        
        // creates the form
        $this->form = new BootstrapFormBuilder('form_NfseExigibilidade');
        $this->form->setFormTitle('Exigibilidade');
