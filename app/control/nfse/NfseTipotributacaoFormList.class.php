<?php
/**
 * NfseTipotributacaoFormList Registration
 * @author  <your name here>
 */
class NfseTipotributacaoFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('NfseTipotributacao');   // defines the active record
        $this->setDefaultOrder('id', 'asc');         // defines the default order
        // $this->setCriteria($criteria) // define a standard filter
        
        // creates the form
        $this->form = new BootstrapFormBuilder('form_NfseTipotributacao');
        $this->form->setFormTitle('Tipo de Tributação');
