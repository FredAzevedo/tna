...
class TurnoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink(_t('New'), new TAction(['TurnoForm', 'onEdit']), 'fa:plus green');
        ...
        $column_nome = new TDataGridColumn('nome', 'Turno', 'left');
        ...
        $action1 = new TDataGridAction(['TurnoForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onInlineEdit($param)
    {
        try
        {
            ...
            $object = new Turno($key); // instantiates the Active Record
            $object->{$field} = $value;
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Turno
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('sample'); // open a transaction with database
            $object = new Turno($key, FALSE); // instantiates the Active Record
