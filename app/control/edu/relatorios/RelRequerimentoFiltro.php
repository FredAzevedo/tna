<?php
/**
 * RelRequerimentoFiltro Form
 * @author  Fred Azc
 */
class RelRequerimentoFiltro extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_RelRequerimentoFiltro');
        $this->form->setFormTitle('Requerimanto');
    ...
    {   
        try
        {
            ...
            $gerar = new RelRequerimento($param);
