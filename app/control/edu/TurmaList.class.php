...
class TurmaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink(_t('New'), new TAction(['TurmaForm', 'onEdit']), 'fa:plus green');
        ...
        $column_nome = new TDataGridColumn('nome', 'Turma', 'left');
        ...
        $action1 = new TDataGridAction(['TurmaForm', 'onEdit'], ['id'=>'{id}']);
