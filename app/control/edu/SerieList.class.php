...
class SerieList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Serie');
        ...
        $this->form->addActionLink(_t('New'), new TAction(['SerieForm', 'onEdit']), 'fa:plus green');
        ...
        $column_nome = new TDataGridColumn('nome', 'Nome da série', 'left');
        ...
        $action1 = new TDataGridAction(['SerieForm', 'onEdit'], ['id'=>'{id}']);
    ...
    public function onInlineEdit($param)
    {
        try
        {
            ...
            $object = new Serie($key); // instantiates the Active Record
            $object->{$field} = $value;
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Serie
            $repository = new TRepository('Serie');
            $limit = 100;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('sample'); // open a transaction with database
            $object = new Serie($key, FALSE); // instantiates the Active Record
