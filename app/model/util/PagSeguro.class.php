<?php
class PagSeguro{
	private $email         = "fredkeyster@hotmail.com";
	private $token_sandbox = "A2E71C3E86C7449B84FF3236C7E98623";
	private $token_oficial = "A2E71C3E86C7449B84FF3236C7E98623";
	private $url_retorno   = "https://sistema.macroerp.com.br/pagseguroNotificacao.php";
	...
	//private $url_redirect = 'https://pagseguro.uol.com.br/checkout/v2/pre-approvals/nc/sender-identification.jhtml?t=';
	...
	public function executeCheckout($dados,$retorno){
		...
		var_dump($this->url_redirect.$xml_obj->code);
	}
